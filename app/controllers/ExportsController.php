...
<img src="images/logo_example.png" alt="test alt attribute" width="100" height="100" border="0" /><img src="" alt="test alt attribute" width="100" height="100" border="0" /><img src="" alt="test alt attribute" width="100" height="100" border="0" />
</div>';
...
//============================================================+
                ...
                /*
                 * PDF Format
                 * Heading - Your Todo List.
                 * Grey, small Generated on date,time
                 * 
                 * Todo.
                 * List
                 * Index. Title. Big bold, Priority color bold.
                 * Added by Name on date time
                 * Description
                 * members. Pic, name, (assigned) 
                 * Attachments:
                 * List (url)
                 * Comments:
                 * comment Index: text
                 * Added on date by image, person name (grey small)
                 * 
                 * 
                 */
            }
